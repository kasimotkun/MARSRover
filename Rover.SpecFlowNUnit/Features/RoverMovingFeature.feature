...
Scenario: move the rover inside the upper and lower coordinates - more moves
  Given a new rover with x=5, y=5 the upper-right coordinates of the plateau
  Given the rover position with x=1, y=1 and facing is 'E'
...
Scenario: move the rover inside the upper and lower coordinates - more lefts
  Given a new rover with x=5, y=5 the upper-right coordinates of the plateau
  Given the rover position with x=3, y=3 and facing is 'W'
...
Scenario: move the rover inside the upper and lower coordinates - more rights
  Given a new rover with x=5, y=5 the upper-right coordinates of the plateau
  Given the rover position with x=3, y=3 and facing is 'E'
